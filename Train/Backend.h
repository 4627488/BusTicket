...
struct BusInfo {
    ...
    int maxPassenger;
    int soldTickets;
    //BusInfo() : busNumber(0), departureHour(0), departureMinute(0), startPoint(""), endPoint(""), duration(0), price(0.0), maxPassenger(0), soldTickets(0) {}
};
...
public:
    ...
    void saveAllBusInfo();
    Q_INVOKABLE void removeBusInfo(QString busNumber);

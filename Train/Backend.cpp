...
{
    qDebug() << "trainNumber: " << trainNumber<< "departureTime: " << departureTime << "startStation: " << startStation << "endStation: " << endStation << "duration: " << duration << "price: " << price << "capacity: " << capacity << "soldTickets: " << soldTickets;
    BusInfo bus{
        trainNumber.toInt(),
...
void Backend::removeBusInfo(QString busNumberStr) {
